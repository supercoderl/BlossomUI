...
const FollowSection = () => {
    return (
        <section className="py-2.5 md:py-[100px] relative" data-aos="fade-zoom-in">
                            ...
                            <div className="">
                                <div className="flex flex-col md:flex-row">
                                    <div className="w-full md:w-1/2 text-center py-[40px] px-[20px]">
                                        <h5 className="mb-[10px] text-[20px] md:text-[22px]">Follow Us</h5>
                                    ...
                                    <div className="border-t md:border-t-0 md:border-l border-solid border-black w-full md:w-1/2 text-center px-5 py-10 md:p-[40px]">
                                        <h5 className="mb-[10px] text-[20px] md:text-[22px]">We Don’t Keep Our Beauty Secrets</h5>
                                        ...
                                        <form className="" method="post" data-id="226" data-name="First form">
                                            <div className="">
                                                <p className="mb-0 relative max-w-[420px] mx-auto bg-white">
                                                    ...
                                                    <input type="submit" value="subscribe" className="absolute top-0 right-0 font-medium text-center uppercase text-black border border-solid border-black inline-block py-[14px] px-[31px]" readOnly />
                                                </p>
                                            </div>
