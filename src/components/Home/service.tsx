                        ...
                        <div className="px-[15px] flex relative w-full flex-wrap content-start">
                            <div className="text-center w-full">
                                <div className="mb-[50px]">
                                    <h2 className="text-black mb-[16px] text-[42px] font-medium">Service Menu </h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="px-[15px] flex relative w-full flex-wrap content-start">
                            <div className="w-full relative">
                                <div>
                                    <div>
                                        <div>
                                            <ul className="flex justify-center pb-[20px] mb-[18px] w-auto text-center flex-nowrap">
                                                <li data-id="1" className="m-0 flex flex-col items-center px-[35px]">
                                                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M34.5 45.5H37.5H40.5V43.5L42 42.5L44.5 40.5L47 37L47.5 34L46 33.5L44.5 33.3125H43.5H42H41L40 33.5H38.5H37.5H36.5H36H35.5H35H33H30.5H27.5V35.5L28.5 38L29.5 40L32 42L34.5 43.5V45.5Z" fill="#F6EBE7"></path>
                                                        <path fillRule="evenodd" clipRule="evenodd" d="M35.2498 22H34.8632L34.766 22.3738L34.766 22.3739L34.766 22.374L34.7659 22.3741L34.7658 22.3745L34.7648 22.3784L34.7599 22.3964C34.7554 22.4127 34.7485 22.4377 34.7392 22.4701C34.7204 22.5351 34.6921 22.6298 34.6545 22.7458C34.579 22.9787 34.4673 23.2937 34.3223 23.6244C34.1765 23.957 34.0022 24.2937 33.8043 24.5761C33.6025 24.8643 33.401 25.0602 33.2138 25.1576C30.6804 26.4765 27.0498 29.2898 27.0498 34.1292C27.0498 35.7728 27.4607 37.5505 28.6062 39.2868C29.7128 40.9642 31.488 42.5775 34.1857 43.9953V45.5V46H34.6857H35.3498H39.6498H40.314H40.814V45.5V43.9953C43.5116 42.5775 45.2869 40.9642 46.3935 39.2868C47.5389 37.5505 47.9498 35.7728 47.9498 34.1292C47.9499 29.2898 44.3193 26.4765 41.7858 25.1576C41.5986 25.0602 41.3972 24.8643 41.1953 24.5761C40.9975 24.2937 40.8231 23.957 40.6773 23.6244C40.5323 23.2937 40.4206 22.9787 40.3451 22.7458C40.3075 22.6298 40.2792 22.5351 40.2605 22.4701C40.2511 22.4377 40.2442 22.4127 40.2397 22.3964L40.2349 22.3784L40.2338 22.3745L40.2337 22.3741L40.2337 22.374L40.2337 22.3739L40.2337 22.3738L40.1364 22H39.7498H39.6498H35.3498H35.2498ZM35.6232 23L35.6058 23.0542C35.5232 23.3088 35.4001 23.6565 35.2382 24.0259C35.077 24.3934 34.8723 24.7945 34.6234 25.1498C34.3785 25.4994 34.0657 25.8415 33.6756 26.0446C31.2449 27.31 28.0498 29.864 28.0498 34.1292C28.0498 35.5987 28.4146 37.1805 29.4409 38.7361C30.4691 40.2947 32.1795 41.8543 34.9125 43.2454L35.1857 43.3845V43.691V45H35.3498H39.6498H39.814V43.691V43.3845L40.0871 43.2454C42.8202 41.8543 44.5305 40.2947 45.5588 38.7361C46.5851 37.1805 46.9498 35.5987 46.9498 34.1292C46.9499 29.864 43.7548 27.31 41.3241 26.0446C40.9339 25.8415 40.6211 25.4994 40.3762 25.1498C40.1273 24.7945 39.9226 24.3934 39.7615 24.0259C39.5995 23.6565 39.4764 23.3088 39.3939 23.0542L39.3765 23H35.6232Z" fill="black"></path>
                                                        <path d="M33.5 8C33.5 7.17157 34.1716 6.5 35 6.5H40C40.8284 6.5 41.5 7.17157 41.5 8V22C41.5 22.2761 41.2761 22.5 41 22.5H34C33.7239 22.5 33.5 22.2761 33.5 22V8Z" fill="#F6EBE7" stroke="black"></path>
                                                        <path d="M14 21.5H14.5V21V4C14.5 2.61929 13.3807 1.5 12 1.5H9C7.61929 1.5 6.5 2.61929 6.5 4V21V21.5H7H14Z" fill="#F6EBE7" stroke="black"></path>
                                                        <path d="M28 33H47V34H28V33Z" fill="black"></path>
                                                        <rect x="37" y="22" width="1" height="16" fill="black"></rect>
                                                        <rect x="1.5" y="21.5" width="18" height="23" rx="0.5" fill="#F6EBE7" stroke="black"></rect>
                                                        <rect x="1.5" y="21.5" width="18" height="7" rx="0.5" fill="white" stroke="black"></rect>
                                                        <rect x="10" y="21" width="1" height="17" fill="black"></rect>
                                                        <rect x="1" y="28" width="19" height="1" fill="black"></rect>
                                                    </svg>
                                                    <span className="white-space-nowrap text-[13px] mt-[22px] pb-[5px] border-b border-solid border-black font-medium">NAILS</span>
                                                </li>
                                                <li data-id="2" className="m-0 flex flex-col items-center px-[35px]">
                                                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M40 28C34.6774 33.3333 29.8387 33.3333 25 28" stroke="black"></path>
                            ...
                            <div className="w-full relative">
                                <div className="mt-[37px]">
                                    <div className="text-center">
                                        <a href="https://firstsight.design/cherie/beauty/service-menu/" className="decoration-none font-medium text-center uppercase text-white bg-black inline-block pt-[16px] pb-[14px] px-[32px]">VIEW SERVICE MENU</a>
                                    </div>
                                </div>
                            </div>
                        </div>
