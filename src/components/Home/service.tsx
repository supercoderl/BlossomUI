                        ...
                        <div className="px-[15px] flex relative w-full flex-wrap content-start">
                            <div className="text-center w-full">
                                <div className="mb-[40px] md:mb-[50px]">
                                    <h2 className="text-black mb-[16px] text-[28px] md:text-[42px] font-medium">Service Menu </h2>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div>
                                        <div>
                                            <ul className="flex md:justify-center pb-[20px] mb-[18px] w-auto text-center flex-nowrap overflow-x-auto md:overflow-x-unset hide-scrollbar">
                                                <li data-id="1" className="m-0 flex flex-col items-center px-3 md:px-[35px]">
                                                ...
                                                <li data-id="2" className="m-0 flex flex-col items-center px-3 md:px-[35px]">
                                                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <li data-id="3" className="m-0 flex flex-col items-center px-3 md:px-[35px]">
                                                ...
                                                <li data-id="4" className="m-0 flex flex-col items-center px-3 md:px-[35px]">
                                                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <li data-id="5" className="m-0 flex flex-col items-center px-3 md:px-[35px]">
