        ...
        <section className="py-[100px] relative">
            ...
            <div className="max-w-[1170px] flex mx-auto relative">
                ...
                <div className="w-[49.959%] relative min-h flex">
                    <div className="content-center items-center ml-[67px] px-[15px] flex relative w-full flex-wrap">
                        <div className="w-full relative">
                            <div className="pt-4 pb-[30px]">
                                <h2 className="mb-4 text-[42px] font-medium">Our Story</h2>
                            </div>
                        </div>
                        <div className="w-full relative">
                            <div className="">
                        ...
                        <div className="w-full relative">
                            <div className="mt-[30px]">
                                <h6 className="mb-4 text-[20px] font-medium">– Emma Underwood</h6>
                            </div>
                        </div>
                    </div>
                </div>
