                    ...
                    <div className="flex relative w-full flex-wrap content-start">
                        <div className="w-full relative">
                            <div className="">
                                <div className="">
                                    <div className="flex">
                                        <div id="scroll-spy" className="overflow-visible min-h min-w-[210px] absolute z-47 pt-[100px]">
                                            <div className={
                                                cn(
                                                    "pb-[1px]",
                                                    scrolled ? "fixed translate-y-[100px] top-0 left-0 w-[210px]" : "static"
                                                )
                                            }>
                                                {
                                                    services.map(item => (
                                                        <ul key={item.id} className="flex flex-col">
                                                            <li className="w-[210px] mb-[50px]">
                                                                <a href={item.href} className="flex flex-col items-center decoration-none relative z-200">
                                                                    {item.icon}
                                                                    <span className="border-b border-solid border-black font-medium text-[13px] mt-[22px] pb-[5px] uppercase">{item.label}</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    ))
                                        ...
                                        <div className="relative overflow-visible min-h w-full mx-auto">
                                            <div className="pb-[1px] static">
                                                <div id="service1" className="bg-white">
                                                    <div className="max-w-[854px] mx-auto py-[100px]">
                                                        <div className="text-center">
                                                            <h2 className="mb-[30px] text-[42px] font-medium">Hair</h2>
                                                            <div className="mb-[50px] px-[120px]">
                                                        ...
                                                        <h5 className="px-[54px] mb-[24px]">Haircut</h5>
                                                        <div className="flex flex-wrap mb-[23px]">
                                                            <div className="w-1/2 px-[54px] mb-[27px]">
                                                        ...
                                                        <h5 className="px-[54px] mb-[24px]">Color</h5>
                                                        <div className="flex flex-wrap mb-[23px]">
                                                            <div className="w-1/2 px-[54px] mb-[27px]">
                                                                <div className="mb-[8px] flex justify-between">
                                                ...
                                                <div id="service2" className=" bg-[#F6EBE7]">
                                                    <div className="max-w-[854px] mx-auto py-[100px]">
                                                        <div className="text-center">
                                                            <h2 className="mb-[30px] text-[42px] font-medium">Makeup</h2>
                                                            <div className="mb-[50px] px-[120px]">
                                                ...
                                                <div id="service3" className=" bg-white">
                                                    <div className="max-w-[854px] mx-auto py-[100px]">
                                                        <div className="text-center">
                                                            <h2 className="mb-[30px] text-[42px] font-medium">Brows</h2>
                                                            <div className="mb-[50px] px-[120px]">
                                                ...
                                                <div id="service4" className=" bg-[#F6EBE7]">
                                                    <div className="max-w-[854px] mx-auto py-[100px]">
                                                        <div className="text-center">
                                                            <h2 className="mb-[30px] text-[42px] font-medium">Nails</h2>
                                                            <div className="mb-[50px] px-[120px]">
                                                ...
                                                <div id="service5" className="">
                                                    <div className="max-w-[854px] mx-auto py-[100px]">
                                                        <div className="text-center">
                                                            <h2 className="mb-[30px] text-[42px] font-medium">Cosmetology</h2>
                                                            <div className="mb-[50px] px-[120px]">
