const CareerSection = () => {
    return (
        <section className="bg-[#F6EBE7] py-[100px]">
                        ...
                        <div className="w-full relative">
                            <div className="">
                                <div className="flex">
                                    ...
                                    <div className="w-1/2 text-center border-l border-solid py-4 px-[40px] border-black">
                                        <div className="">
                                        ...
                                        <h5 className="mt-4 mb-2.5 text-[22px] text-black">Become Our Partner</h5>
                                        <div className="mb-[30px]">
